    ...
    class SSH
        ...
        def wait_for_regex(expression)
            ...
            until (match or timeout)
                ...
                #get length of examine_this_text because we have to treat last line differently
                # it may get more stuff added to it so we don't add it to processed immediately
                ...
                examine_this_text.lines.each do |line|
                    current_line += 1
                    #should be true if last line has been reached
